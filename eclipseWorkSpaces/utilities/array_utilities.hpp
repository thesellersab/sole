...
/*
	===============================================================================
	2-D Array Utility functions
	===============================================================================
*/


template <typename tt_type, int tp_rows, int tp_cols>
void print2DArray(tt_type p_data[tp_rows][tp_cols])
{
	for (int row = 0; row < tp_rows; ++row)
	{
		...
		{
			std::cout<<std::setw(4)<<p_data[row][col]<<", ";
		}
		std::cout<<std::endl;
	}
}
...
template <typename tt_type, int tp_rows, int tp_cols>
void gen2DArrayCountingData(tt_type p_data[tp_rows][tp_cols])
{
	tt_type count=0;
	for (int row = 0; row < tp_rows; ++row)
	{
		for (int col = 0; col < tp_cols; ++col)
		{
			p_data[row][col] = count++;
		}
	}
}

}// end namespace maosikar
